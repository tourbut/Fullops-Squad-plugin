...
## 0.7.7 task-create 배정 인식

`task-create` 후 `worker-start --task`로 배정해도 flow-gate가 과제 spec에서 분류된 과제 키를 찾습니다. 차단 문구에 최근 분류된 키를 보여 줍니다. [변경 범위](docs/releases/0.7.7.md)
